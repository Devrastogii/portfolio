    ...
    <>
          <section id='achievements' className='achieve_styling'>
            <div className='pl-12 text-white'>
                <motion.div whileInView={{opacity: 1}} initial={{opacity: 0}} transition={{duration: 1.5}} className='lg:mt-96 text-[32px] font-medium '>Achievements</motion.div>
            ...
            <div className='flex justify-evenly -ml-1 w-full mt-20 achieve_card_styling'>
                ...
                <motion.img initial={{translateX: -50}} whileInView={{translateX: 0}} transition={{duration: 1, delay: 0.3}} src={mp} className='w-[350px] h-[265px] absolute z-0 img_card_styling' /> 
                    {show && (
                    <>
                      {index === 3 ? (
                        <>
                        <motion.div className='w-[350px] h-[265px] opacity-70 bg-black z-5 black_styling'></motion.div>
                        <motion.div className='w-[360px] h-28 text-white font-bold tracking-wide text-xl mt-[160px] pl-4 transition-all duration-300 uppercase flex italic items-center absolute z-10' initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1.2}}>Moksha Photography</motion.div>
