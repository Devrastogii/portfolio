                ...
                <div className='justify-start w-1/2'>
                    ...
                    <div className='flex justify-end w-1/2 text-[17px] text-[#C8C8C8] font-medium nav_styling'>
                        ...
                        <div className='pl-7 -mt-1'>
                            <a href='https://drive.google.com/file/d/1uy6p7vaAbS-STRbXhJuMuLs_COqdtl2a/view?usp=sharing' target='_blank' className='w-[190px] h-[40px] border-[3px] flex justify-center items-center border-[#00D1FF] font-medium text-[#00D1FF] hover:bg-[#00D1FF] hover:text-white tracking-widest transition ease-in btn_styling'>RESUME</a>
                        </div>                                                                       
                    </div>
